  ...
  return (
    <div className="flex flex-col items-center gap-8">
      <div className={poemCard}>
        ...
        <div className="w-24 h-24 absolute top-0 right-4 flex justify-center items-center rounded-full group-hover:bg-gradient-to-b group-hover:from-black group-hover:to-indigo-200 group-shadow-md group-shadow-rose-200 cursor-pointer duration-300">
          <GiFairyWings className="w-[80%] h-full p-5 text-zinc-700 group-hover:text-rose-400" />
        </div>
      </div>
    </div>
  )
