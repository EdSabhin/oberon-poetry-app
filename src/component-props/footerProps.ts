const footerProps = {
  shakespeare: {
    playwright: {
      footerClass: `w-full flex flex-col items-center relative pt-10 pb-24 px-3 md:px-48 bg-gradient-to-r from-gray-950 via-slate-800 to-gray-950 tracking-wider`,
      footerContainer:
        "flex flex-col md:flex-row md:items-start px-6 md:pl-10 mb-8 md:mb-0 gap-20 md:gap-32 border-x border-orange-300 border-opacity-10",
      titleClass:
      ...
      quoteVerseClass:
        "flex py-10 md:px-4 text-2xl text-verse-animation cursor-pointer",
    ...
    bloodNight: {
      footerClass: `w-full flex flex-col items-center relative pt-10 pb-24 px-3 md:px-48 bg-gradient-to-r from-black via-rose-950 to-black tracking-wider`,
      footerContainer:
        "flex flex-col md:flex-row md:items-start px-6 md:pl-10 mb-8 md:mb-0 gap-20 md:gap-32 border-x border-rose-200 border-opacity-10",
      titleClass:
  ...
  dickinson: {
    sylph: {
      footerClass: `w-full flex flex-col items-center relative pt-10 pb-24 px-3 md:px-48 bg-gradient-to-b from-indigo-100 via-rose-200 to-purple-200 tracking-wider`,
      footerContainer:
        "flex flex-col md:flex-row md:items-start px-6 md:pl-10 mb-8 md:mb-0 gap-20 md:gap-32 border-x border-indigo-400 border-opacity-30",
      titleClass:
      ...
      quoteVerseClass:
        "flex py-10 md:px-4 text-2xl text-verse-cyan-animation cursor-pointer",
      attributions:
    ...
    elegy: {
      footerClass: `w-full flex flex-col items-center relative pt-10 pb-24 px-3 md:px-48 bg-gradient-to-b from-cyan-950 via-cyan-600 to-neutral-950 tracking-wider`,
      footerContainer:
        "flex flex-col md:flex-row md:items-start px-6 md:pl-10 mb-8 md:mb-0 gap-20 md:gap-32 border-x border-lime-300 border-opacity-30",
      titleClass:
      ...
      quoteVerseClass:
        "flex py-10 md:px-4 text-2xl text-verse-indigo-animation cursor-pointer",
      attributions:
