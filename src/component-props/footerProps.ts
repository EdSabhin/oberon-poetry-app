const footerProps = {
  shakespeare: {
    playwright: {
      ...
      quoteVerseClass:
        "flex py-[0.7rem] md:px-4 text-2xl text-verse-animation cursor-pointer",
      ...
      links: `text-center md:text-start text-indigo-200
    ...
    bloodNight: {
      ...
      links: `text-stone-400 text-center hover:text-rose-200 rounded italic transition ease-in-out text-lg`,
    },
  },
  dickinson: {
    sylph: {
