const headerProps = {
  shakespeare: {
    playwright: {
      ...
      authorClass:
        "text-[3rem] md:text-[4rem] xl:text-7xl items-center md:items-start underline underline-offset-8 decoration-double decoration-1 decoration-amber-200 py-4 px-4 md:pr-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-100 to-yellow-900",
    ...
    bloodNight: {
      ...
      authorClass:
        "text-[3rem] md:text-[4rem] xl:text-7xl underline underline-offset-8 decoration-double decoration-1 decoration-rose-900 py-4 pr-4 text-transparent bg-clip-text bg-gradient-to-r from-stone-600 to-70% via-rose-500 to-stone-500",
