const mainProps = {
  shakespeare: {
    playwright: {
      mainClass:
        "w-full flex flex-col items-start pt-8 pb-20 px-48 text-stone-200 bg-gradient-to-r from-black via-gray-600 to-black",
      ...
      poemCard: {
        ...
        poemButton:
          "absolute top-[6.4%] right-[-16.7%] text-color-animation bg-gradient-to-r from-slate-800 to-stone-800 shadow-md shadow-stone-950 rounded-br-full transition ease-in-out delay-400 duration-300 group-hover:bg-gradient-to-br group-hover:from-stone-900 group-hover:to-stone-700 group-hover:text-stone-200",
        titleClass:
    ...
    bloodNight: {
      mainClass:
        " w-full flex flex-col items-start pt-8 pb-20 px-48 text-stone-200 bg-gradient-to-r from-black via-rose-900 to-black",
